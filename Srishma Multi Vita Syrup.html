      ...
      <div class="productbox">
        <div class="allimages">
          ...
          <div class="main-images">
            <img src="patent product image/Srishma Multi Vita Syrup.jpg" id="imagebox" />
          </div>
        </div>
      </div>
      <div class="text">
        <div class="content">
          ...
          <p class="Product-name">Srishma Multi Vita Syrup</p>
        </div>
        <div class="pricebox">
          ...
          <p>
            <b>Description: </b> Introducing Srishma Multi Vita Syrup – your comprehensive source of essential vitamins
            from Srishma. Expertly crafted, this syrup provides a blend of vitamins to support overall health and
            vitality. With natural ingredients, it fills nutritional gaps and promotes optimal well-being. Experience
            the benefits of complete nutrition with Srishma Multi Vita Syrup.
          </p>
        </div>
