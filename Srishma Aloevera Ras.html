      ...
      <div class="productbox">
        <div class="allimages">
          <div class="smallimages">
            <img src="patent product image/Aloevera Juice/Aloevera Juice.jpg" onclick="clickimg(this)" />
            <img src="patent product image/Aloevera Juice/3.jpg" onclick="clickimg(this)" />
            <img src="patent product image/Aloevera Juice/4.jpg" onclick="clickimg(this)" />
          </div>
          <div class="main-images">
            <img src="patent product image/Aloevera Juice/Aloevera Juice.jpg" id="imagebox" />
          </div>
        </div>
      </div>
      <div class="text">
        <div class="content">
          ...
          <p class="Product-name">Srishma Aloevera Ras</p>
        </div>
        <div class="pricebox">
          ...
          <p>
            <b>Description: </b>Discover the refreshing power of nature with our hydrating and revitalizing aloe vera
            juice. Packed with essential vitamins, minerals, and antioxidants, our carefully crafted beverage supports
            your overall well-being. From aiding digestion to boosting immunity, each sip offers a natural burst of
            hydration and vitality. Experience the goodness of nature in every glass.
          </p>
        </div>
