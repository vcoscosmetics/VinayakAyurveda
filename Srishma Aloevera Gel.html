      ...
      <div class="productbox">
        <div class="allimages">
          <div class="smallimages">
            <img src="patent product image/ALOEVERA/Srishma Aloevera Gel.jpg" onclick="clickimg(this)" />
            <img src="patent product image/ALOEVERA/2.jpg" onclick="clickimg(this)" />
            <img src="patent product image/ALOEVERA/5.jpg" onclick="clickimg(this)" />
          </div>
          <div class="main-images">
            <img src="patent product image/ALOEVERA/Srishma Aloevera Gel.jpg" id="imagebox" />
          </div>
        </div>
      </div>
      <div class="text">
        <div class="content">
          ...
          <p class="Product-name"> Srishma Aloevera Gel</p>
        </div>
        <div class="pricebox">
          <p class="price"><i class="fa-solid fa-indian-rupee-sign" style="color: #050505;"></i>20/- Per Piece</p>
          ...
          <p>
            <b>Description: </b>A soothing skincare product derived from the aloe vera plant, this gel-like substance
            boasts numerous therapeutic properties. Packed with vitamins, minerals, and antioxidants, it effectively
            moisturizes and nourishes the skin. Its versatility extends to soothing sunburns, hydrating dry skin,
            reducing inflammation, and enhancing overall skin health. Lightweight and easily absorbed, it suits all skin
            types.
