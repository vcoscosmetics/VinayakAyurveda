            ...
            <div class="productbox">
                <div class="allimages">
                    <div class="smallimages">
                        <img src="product-images/SUNFLOWER SEEDS/1.jpg" onclick="clickimg(this)" />
                        <img src="product-images/SUNFLOWER SEEDS/3.jpg" onclick="clickimg(this)" />
                        <img src="product-images/SUNFLOWER SEEDS/2.jpg" onclick="clickimg(this)" />
                    </div>
                    <div class="main-images">
                        <img src="product-images/SUNFLOWER SEEDS/1.jpg" id="imagebox" />
                    </div>
                </div>
            </div>
            <div class="text">
                <div class="content">
                    ...
                    <p class="Product-name">Srishma Sunflower Seeds</p>
                </div>
                <div class="pricebox">
                    ...
                    <p>
                        ...
                        Experience the sunny delight of Sunflower Seeds. These crunchy kernels are a powerhouse of
                        vitamins, minerals, and healthy fats, perfect for snacking or adding to salads and baked goods.
                        Packed with antioxidants and protein, they promote heart health and aid in weight management.
                        Embrace the natural goodness of Sunflower Seeds for a tasty and nutritious boost to your day.
                    </p>
                </div>
