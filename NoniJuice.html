        ...
        <div class="productbox">
          <div class="allimages">
            <div class="smallimages">
              <img src="product-images/Noni Juice/1.jpg" onclick="clickimg(this)" />
              <img src="product-images/Noni Juice/2.jpg" onclick="clickimg(this)" />
              <img src="product-images/Noni Juice/3.jpg" onclick="clickimg(this)" />
            </div>
            <div class="main-images">
              <img src="product-images/Noni Juice/1.jpg" id="imagebox" />
            </div>
          </div>
        </div>
        <div class="text">
          <div class="content">
            ...
            <p class="Product-name">Noni Juice</p>
          </div>
          <div class="pricebox">
            ...
            <p>
              <b>Description:</b> Well noni juice concentrate combined with the goodness of kokum is a powerful, health-giving food formulated from nature for greater health, greater energy, vitality, body balancing and well-being Noni is known to help revitalize cells and tissues Boosts immunity, provides better vigor and vitality and increases mental and physical energy. Well noni juice concentrate combined with the goodness of kokum is a powerful, health-giving food formulated from nature for greater health, greater energy, vitality, body balancing and well-being. Noni is known to help revitalize cells & tissues, boosts immunity, provides better vigor & vitality and increases mental & physical energy.
            </p>
          </div>
