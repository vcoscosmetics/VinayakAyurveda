        ...
        <div class="productbox">
          <div class="allimages">
            <div class="smallimages">
              <img src="patent product image/JAMUN POWDER/Srishma Jamun Powder.jpg" onclick="clickimg(this)" />
              <img src="patent product image/JAMUN POWDER/2.jpg" onclick="clickimg(this)" />
              <img src="patent product image/JAMUN POWDER/3.jpg" onclick="clickimg(this)" />
            </div>
            <div class="main-images">
              <img src="patent product image/JAMUN POWDER/Srishma Jamun Powder.jpg" id="imagebox" />
            </div>
          </div>
        </div>
        <div class="text">
          <div class="content">
            ...
            <p class="Product-name">Srishma Jamun Powder</p>
          </div>
          <div class="pricebox">
