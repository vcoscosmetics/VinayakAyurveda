      ...
      <div class="productbox">
        <div class="allimages">
          <div class="smallimages">
            <img src="patent product image/Ashwagandha Capsule/Srishma Ashwagandha Capsule.jpg"
              onclick="clickimg(this)" />
            <img src="patent product image/Ashwagandha Capsule/2.jpg" onclick="clickimg(this)" />
            <img src="patent product image/Ashwagandha Capsule/3.jpg" onclick="clickimg(this)" />
          </div>
          <div class="main-images">
            <img src="patent product image/Ashwagandha Capsule/Srishma Ashwagandha Capsule.jpg" id="imagebox" />
          </div>
        </div>
      </div>
      <div class="text">
        <div class="content">
          ...
          <p class="Product-name">Srishma Ashwagandha Capsule</p>
        </div>
        <div class="pricebox">
          <p class="price"><i class="fa-solid fa-indian-rupee-sign" style="color: #050505;"></i>110/- Per Piece</p>
          ...
          <p>
            <b>Description: </b>A supplement encapsulating the powdered form of a renowned adaptogenic herb, it offers
            numerous health benefits. Derived from the roots of the Withania somnifera plant, it is prized for its
            ability to combat stress, enhance vitality, and promote overall well-being. Rich in antioxidants and
            bioactive compounds, it supports immune function, improves cognitive function, and helps maintain hormonal
            balance.
          </p>
        </div>
