        ...
        <div class="productbox">
          <div class="allimages">
            <div class="smallimages">
              <img src="1.jpg" onclick="clickimg(this)" />
              <img src="2.jpg" onclick="clickimg(this)" />
              <img src="3.jpg" onclick="clickimg(this)" />
            </div>
            <div class="main-images">
              <img src="1.jpg" id="imagebox" />
            </div>
          </div>
        </div>
        <div class="text">
          ...
          <div class="pricebox">
            <p class="price"><i class="fa-solid fa-indian-rupee-sign" style="color: #050505;"></i>75/kg</p>
            ...
            <p>
              <b>Description: </b> Orange Peel Powder is a 100% pure, natural and
