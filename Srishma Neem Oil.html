      ...
      <div class="productbox">
        <div class="allimages">
          <div class="smallimages">
            <img src="patent product image/NEEM OIL/Srishma Neem Oil.jpg" onclick="clickimg(this)" />
            <img src="patent product image/NEEM OIL/2.jpg" onclick="clickimg(this)" />
            <img src="patent product image/NEEM OIL/3.jpg" onclick="clickimg(this)" />
          </div>
          <div class="main-images">
            <img src="patent product image/NEEM OIL/Srishma Neem Oil.jpg" id="imagebox" />
          </div>
        </div>
      </div>
      <div class="text">
        <div class="content">
          ...
          <p class="Product-name">Srishma Neem Oil</p>
        </div>
        <div class="pricebox">
          <p class="price"><i class="fa-solid fa-indian-rupee-sign" style="color: #050505;"></i>195/- Per Piece</p>
          ...
          <p>
            <b>Description: </b>Introducing Srishma Neem Oil, a nourishing hair oil from the esteemed Srishma brand.
            Infused with the goodness of neem, this oil promotes scalp health and stimulates hair growth. It effectively
            combats dandruff and strengthens hair follicles, leaving your hair soft, shiny, and revitalized. Embrace the
            natural benefits of Srishma Neem Oil for healthier, more beautiful hair.
          </p>
        </div>
