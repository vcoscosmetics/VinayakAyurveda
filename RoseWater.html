        ...
        <div class="productbox">
          <div class="allimages">
            <div class="smallimages">
              <img src="product-images/Rose Water/1.jpg" onclick="clickimg(this)" />
              <img src="product-images/Rose Water/2.jpg" onclick="clickimg(this)" />
              <img src="product-images/Rose Water/3.jpg" onclick="clickimg(this)" />
            </div>
            <div class="main-images">
              <img src="product-images/Rose Water/1.jpg" id="imagebox" />
            </div>
          </div>
        </div>
        <div class="text">
          <div class="content">
            ...
            <p class="Product-name">Rose Water</p>
          </div>
          <div class="pricebox">
            <p class="price"><i class="fa-solid fa-indian-rupee-sign" style="color: #050505;"></i>25/- Per Piece</p>
            ...
            <p>
              Description: Orange Peel Powder is a 100% pure, natural and
              organic herb powder made by crushing the peels of organically
              grown oranges in select Indian farms. The peels have been shade
              dried and processed naturally to preserve their full nutritional
              values. Enriched with vitamins C & B, flavonoid, antioxidants and
              antibacterial properties, calcium and magnesium, this healing herb
              powder comes highly recommended for intensive skincare and hair
              care.
            </p>
          </div>
