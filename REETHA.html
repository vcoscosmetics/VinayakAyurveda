        ...
        <div class="productbox">
          <div class="allimages">
            <div class="smallimages">
              <img src="product-images/REETHA/1.jpg" onclick="clickimg(this)" />
              <img src="product-images/REETHA/2.jpg" onclick="clickimg(this)" />
              <img src="product-images/REETHA/3.jpg" onclick="clickimg(this)" />
            </div>
            <div class="main-images">
              <img src="product-images/REETHA/1.jpg" id="imagebox" />
            </div>
          </div>
        </div>
        <div class="text">
          <div class="content">
            ...
            <p class="Product-name">Reetha Powder</p>
          </div>
          <div class="pricebox">
            <p class="price"><i class="fa-solid fa-indian-rupee-sign" style="color: #050505;"></i>85/- Per Kg</p>
            ...
            <p>
              <b>Description:</b> Reetha Powder is a natural product that provides all sorts of haircare required by your delicate strands. Reetha has been considered the perfect friend for hair since ages and thus this product is a perfect solution to get great, attractive hair naturally. Reetha powder removes dirt and excess oil from the hair and scalp.
            </p>
          </div>
