        ...
        <div class="productbox">
          <div class="allimages">
            <div class="smallimages">
              <img src="product-images/Papaya Gel/1.jpg" onclick="clickimg(this)" />
              <img src="product-images/Papaya Gel/2.jpg" onclick="clickimg(this)" />
              <img src="product-images/Papaya Gel/3.jpg" onclick="clickimg(this)" />
            </div>
            <div class="main-images">
              <img src="product-images/Papaya Gel/1.jpg" id="imagebox" />
            </div>
          </div>
        </div>
        <div class="text">
          <div class="content">
            ...
            <p class="Product-name">Papaya Gel</p>
          </div>
          <div class="pricebox">
