      ...
      <div class="productbox">
        <div class="allimages">
          <!-- <div class="smallimages">
              <img src="product-images/Cough Serup/Cough-Serup-1.jpg" onclick="clickimg(this)" />
              <img src="product-images/Cough Serup/Cough-Serup-2.jpg" onclick="clickimg(this)" />
              <img src="product-images/Cough Serup/Cough-Serup-3.jpg" onclick="clickimg(this)" />
            </div> -->
          <div class="main-images">
            <img src="patent product image/Srishma Liver Syrup.jpg" id="imagebox" />
          </div>
        </div>
      </div>
      <div class="text">
        <div class="content">
          ...
          <p class="Product-name">Srishma Liver Syrup</p>
        </div>
        <div class="pricebox">
          ...
          <p>
            <b>Description: </b> Introducing Srishma Liver Syrup – a specialized tonic for liver health from Srishma.
            Formulated with care, this syrup supports liver function and promotes detoxification. With natural
            ingredients known for their hepatic benefits, it aids in maintaining liver health and vitality. Experience
            the rejuvenating effects of Srishma Liver Syrup for optimal liver function and overall well-being.
          </p>
        </div>
