      ...
      <div class="productbox">
        <div class="allimages">
          <div class="smallimages">
            <img src="product-images/Beetroot Powder/Beetroot-Powder-1.jpg" onclick="clickimg(this)" />
            <img src="product-images/Beetroot Powder/Beetroot-Powder-2.jpg" onclick="clickimg(this)" />
            <img src="product-images/Beetroot Powder/Beetroot-Powder-3.jpg" onclick="clickimg(this)" />
          </div>
          <div class="main-images">
            <img src="product-images/Beetroot Powder/Beetroot-Powder-1.jpg" id="imagebox" />
          </div>
        </div>
      </div>
      <div class="text">
        <div class="content">
          ...
          <p class="Product-name">Beetroot Powder</p>
        </div>
        <div class="pricebox">
          ...
          <p>
            <b>Description: </b> Beetroot (Beta vulgaris) is a root vegetable
            also known as red beet, table beet, garden
            beet, or just beet. Packed with essential nutrients, beetroots are
            a great source of fiber, folate (vitamin
            B9), manganese, potassium, iron, and vitamin C. Beetroots and
            beetroot juice have been associated with
            numerous health benefits, including improved blood flow, lower
            blood pressure, and increased exercise
            performance. Beets are good sources of vitamins and minerals, such
            as folate, manganese, potassium, iron,
            and vitamin C. Beetroots can lower blood pressure, which may lead
            to reduced risk of heart disease and other
            ailments. This root veggie can also improve oxygen use, stamina,
