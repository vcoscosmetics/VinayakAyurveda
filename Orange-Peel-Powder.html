        ...
        <div class="productbox">
          <div class="allimages">
            <div class="smallimages">
              <img src="product-images/ORANGE/1.jpg" onclick="clickimg(this)" />
              <img src="product-images/ORANGE/2.jpg" onclick="clickimg(this)" />
              <img src="product-images/ORANGE/3.jpg" onclick="clickimg(this)" />
            </div>
            <div class="main-images">
              <img src="product-images/ORANGE/1.jpg" id="imagebox" />
            </div>
          </div>
        </div>
        <div class="text">
          <div class="content">
            ...
            <p class="Product-name">Orange Peel Powder</p>
          </div>
          <div class="pricebox">
            <p class="price"><i class="fa-solid fa-indian-rupee-sign" style="color: #050505;"></i>75/- Per Kg</p>
