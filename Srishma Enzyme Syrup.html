      ...
      <div class="productbox">
        <div class="allimages">
          ...
          <div class="main-images">
            <img src="patent product image/Srishma Enzyme Syrup.jpg" id="imagebox" />
          </div>
        </div>
      </div>
      <div class="text">
        <div class="content">
          ...
          <p class="Product-name">Srishma Enzyme Syrup</p>
        </div>
        <div class="pricebox">
          ...
          <p>
            <b>Description: </b> Srishma Enzyme Syrup by Srishma is a premium digestive health supplement. Formulated
            with potent enzymes, it aids in breaking down proteins, fats, carbs, and fiber for better nutrient
            absorption. Gentle on the stomach, its natural formula alleviates digestive discomforts like bloating and
            gas. Convenient to use, it supports overall wellness by promoting a healthy gut.
          </p>
        </div>
