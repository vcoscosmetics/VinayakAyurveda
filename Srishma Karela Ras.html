  ...
  <header>
    ...
    <div class="navbar h-nav">
      ...
      <ul class="nav-list">
        ...
        <li><a href="patentproduct.html" class="nav-link">Patent Products</a></li>
        <li><a href="PCDpharma.html" class="nav-link">PCD Pharma Franchise</a></li>
        <li><a href="thirdparty.html" class="nav-link">Third Party Manufacuring</a></li>
