        ...
        <div class="productbox">
          <div class="allimages">
            ...
            <div class="main-images">
              <img src="product-images/Cough Serup/Cough-Serup-1.jpg" id="imagebox" />
            </div>
          </div>
        </div>
        <div class="text">
          <div class="content">
            ...
            <p class="Product-name">Cough Syrup</p>
          </div>
          <div class="pricebox">
            ...
            <p>
              <b>Description: </b> Syrup of Charak helps in healing sore throat and Helps in relieving all types of coughs. Unlike conventional syrups, it does not contain drowsiness causing ingredients; the natural components of it are free from side-effects. This powerful combination of herbs contains expectorant and mucolytic properties and helps in allergic and other respiratory symptoms.
            </p>
          </div>
