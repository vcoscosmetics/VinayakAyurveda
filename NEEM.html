        ...
        <div class="productbox">
          <div class="allimages">
            <div class="smallimages">
              <img src="product-images/NEEM/1.jpg" onclick="clickimg(this)" />
              <img src="product-images/NEEM/2.jpg" onclick="clickimg(this)" />
              <img src="product-images/NEEM/3.jpg" onclick="clickimg(this)" />
            </div>
            <div class="main-images">
              <img src="product-images/NEEM/1.jpg" id="imagebox" />
            </div>
          </div>
        </div>
        <div class="text">
          ...
          <div class="pricebox">
            <p class="price"><i class="fa-solid fa-indian-rupee-sign" style="color: #050505;"></i>60/- Per Kg</p>
            ...
            <p>
              Description: Neem Powder is made from dried neem leaves. How To Use:- To make an anti-dandruff neem pack, you can mix 4 tablespoons of neem powder with some water to make a paste, apply on your scalp and wash it with water after 40 minutes. Apply neem powder paste on the acne and allow it to stay overnight for acne issue. 
            </p>
          </div>
